...
router.delete('/remove/removeGroupSubStandard/:groupSubStdId', [verifyToken, permit('ADMIN')], asyncWrapper(standardController.removeGroupSubStandard));
router.delete('/remove/removeSubStandard/:subStdId', [verifyToken, permit('ADMIN')], asyncWrapper(standardController.removeSubStandard));
